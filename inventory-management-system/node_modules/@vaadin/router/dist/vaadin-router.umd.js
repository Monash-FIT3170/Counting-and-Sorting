(function (global, factory) {
  ...
  var notFoundResult = new ( /*#__PURE__*/_createClass(function NotFoundResult() {
  ...
  function matchPath(routepath, path, exact, parentKeys, parentParams) {
    ...
    var regexp = cache$1.get(cacheKey);
    if (!regexp) {
      var keys = [];
      regexp = {
        keys: keys,
   ...
   * LICENSE.txt file in the root directory of this source tree.
   */
  var pathToRegexp = Resolver.pathToRegexp;
  var cache = new Map();
    ...
    _createClass(Router, [{
      ...
      value: function render(pathnameOrContext, shouldUpdateHistory) {
        ...
        .then(function (context) {
          ...
          if (_this3.__isLatestRender(context)) {
            var previousContext = _this3.__previousContext;
      ...
      value: function __fullyResolveChain(topOfTheChainContextBeforeRedirects) {
        ...
        .then(function (contextAfterRedirects) {
          ...
          var isFound = matchedPath === contextAfterRedirects.pathname;
      ...
      value: function __addAppearingContent(context, previousContext) {
        ...
        var deepestCommonParent = this.__copyUnchangedElements(context, previousContext);
        ...
        function (e) {
          return _this10.__addedByRouter.get(e) &&
